...
create_clock -period 100.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports CLK_IN]
...
set_property PACKAGE_PIN C2 [get_ports ARSTN_IN]
set_property IOSTANDARD LVCMOS33 [get_ports ARSTN_IN]
...
set_property PACKAGE_PIN R10 [get_ports UART_0_rxd]
set_property PACKAGE_PIN T10 [get_ports UART_0_txd]
